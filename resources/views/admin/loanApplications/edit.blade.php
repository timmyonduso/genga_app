    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.loan-applications.update", [$loanApplication->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('loan_amount') ? 'is-invalid' : '' }}" type="dat" name="loan_amount" id="loan_amount" value="{{ old('loan_amount', $loanApplication->loan_amount) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('repayment_date') ? 'is-invalid' : '' }}" name="repayment_date" id="repayment_date">{{ old('repayment_date', $loanApplication->repayment_date) }}</textarea>
